# DisplayName: Jolla @DEVICE@/@ARCH@ (release) 1
...
part / --size 4000 --ondisk sda --fstype=ext4

## No suitable configuration found in /tmp/sandbox/usr/share/ssu/kickstart/bootloader

repo --name=local-@RELEASE@ --baseurl=file:///home/tone/checkouts/git/crodarossa/platform/install
...
repo --name=mer-tools --baseurl=http://repo.merproject.org/obs/mer-tools:/stable/latest_i486/

%packages
@jolla-sailfish-applications
@jolla-ui-wayland
libdrm-2.4.70-1
libdrm-intel-2.4.70-1
mesa-x86-9.2.5-0
mesa-x86-libEGL-9.2.5
mesa-x86-libGLESv2-9.2.5
mesa-x86-libglapi-9.2.5-0
mesa-x86-libwayland-egl-9.2.5
libpciaccess
...
%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/@DEVICE@
